                    ...
                    <div className="topRight">
                        <div className="topbarIcons">
                            <div className="topbarIconContainer">
                                ...
                                <span className="logo">
                                    <a className="logo"  href="https://github.com/SAP/risk-explorer-for-sofware-supply-chains" target="_blank"><GitHubIcon style={{fontSize: "30px",marginTop:"45%"}}></GitHubIcon></a>
                                </span>
